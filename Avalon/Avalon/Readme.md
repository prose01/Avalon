...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Avalon*):
...
Execute unit tests
```
    cd "Avalon/test/Avalon.Tests"
    dotnet test
```

Deploy application
```
    cd "Avalon/src/Avalon"
